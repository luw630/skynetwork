...
function TableRequest.doaction(request)
	...
	local ismove,chesslink = table_data.gogame:CanMove(seat.index,request.action_x,request.action_y)
	if request.action_type == EActionType.ACTION_TYPE_LAOZI and ismove == 0 then
